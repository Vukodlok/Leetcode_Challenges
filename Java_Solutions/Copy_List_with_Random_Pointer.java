/*
* Leetcode Challenge: Copy List with Random Pointer
*
...
class Solution {
    ...
    /*
    * Create a deep copy on a linked list with random pointers.
    * @params head, original linked list provided
    * @return deep copy of head
    */
        //empty list
        if (head == null) {
            return null;
        ...
        //create a dictionary for old node and new node mapping
        Map<Node, Node> oldToNew = new HashMap<>();

        //pass a copy to all nodes
        Node current = head;
        while (current != null) {
